...
/**
 * @title ValidChildTunnel
 */
contract ValidChildTunnel is FxBaseChildTunnel, Create2 {
    ...
    function _processMessageFromRoot(
        ...
        if (syncType == DEPOSIT) {
            ...
            revert('ValidChildTunnel: INVALID_SYNC_TYPE');
        }
    }
    ...
    function _mapToken(bytes memory syncData) internal returns (address) {
        ...
        require(childToken == address(0x0), 'ValidChildTunnel: ALREADY_MAPPED');
    ...
    function _withdraw(
        ...
        require(
            ...
            'ValidChildTunnel: NO_MAPPED_TOKEN'
        );
